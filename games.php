                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="games.php?delete_id=<?php echo $game['game_id']; ?>" class="btn small delete-btn" onclick="return confirm('Are you sure you want to delete this game? All related data will also be deleted.');">Delete</a>
                        </td>
                    </tr>
                <?php 
                    endwhile;
